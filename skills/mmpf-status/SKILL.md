...
- Say: "You're in discussion mode. Keep talking it through, then run `/mmpf-research` if there are unknowns to investigate or `/mmpf-plan` if you're ready to plan."
